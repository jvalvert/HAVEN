...
set @rowid=0;
create temporary table balance_profit
(

select (@rowid:=@rowid+1) rowid,taker_tick BalanceDateTime, T,P_T_INIT preset_t_used,P_MAKER_INIT_BTC maker_init_btc,
...
create temporary table balance_profit_p(
